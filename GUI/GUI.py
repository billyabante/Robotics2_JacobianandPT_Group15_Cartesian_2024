...
#Path and Trajectory 
PT = LabelFrame(gui,text="        Path & Trajectory Planning        ",bg="black", fg="#cf3a60",font=(12))
PT.grid(row=3,column=0)

#Buttons for PT
PnP = Button(PT,text="Pick & Place",font=(10),bg="violet", fg="black",command=p_t)
Weld = Button(PT,text="Welding",font=(10),bg="hot pink", fg="black",command=weld)
